...
class AzureMLFlowSession(MLFlowSession):
    ...
    def init_credential(self, credential_type: str = "DefaultAzureCredential", credential_args: dict = {}):
    ...
    def get_session(self, credential_type: str = "DefaultAzureCredential", credential_args: dict = {}):
